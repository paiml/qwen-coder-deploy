...
1. **Fused Q4K GEMM (PMAT-054)** would close the TTFT gap by replacing FP8 2-step pipeline with 1-step fused quantized GEMM — making realizr prompt-invariant like llama.cpp
